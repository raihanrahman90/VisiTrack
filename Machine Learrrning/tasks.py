...
def runProgram():
    ...
    while(True):
        ...
        if(len(detected)>0):
            ...
            message_title = "Pelanggaran Protokol"
            message_body = "Ditemukan pelanggaran protokol kesehatan oleh {} orang".format(len(detected))
            data_message = {"idPelanggaran":idPelanggaran}
